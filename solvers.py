...
@partial(jit, static_argnums=0)
def vel_step(N: int, grid_points: np.ndarray, u: Grid, v: Grid, u0: Grid, v0: Grid, visc: float, dt: float):
    ...
    u = advect(N, 1, grid_points, u0, u0, v0, dt)
    v = advect(N, 2, grid_points, v0, u0, v0, dt)
